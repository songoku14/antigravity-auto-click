...
- **Quy tắc & Quy trình**:
  - Tuyệt đối tuân thủ **Section 4 & Section 6** của [RULES.md](../rules/RULES.md).
  - CẤM chạy lệnh thực thi code nếu chưa có `implementation_plan.md` được Orchestrator và người dùng xác nhận.
- **Debug & Sửa lỗi**:
  - **Atomicity**: Chia nhỏ việc sửa lỗi thành các bước cực nhỏ.
