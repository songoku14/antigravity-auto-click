...
- **Thống kê Accept theo category**: `node scripts/tools/list-accept-stats.js` - Tổng hợp số lần Auto-Accept được nhận diện (Qua lọc) theo từng nhóm `terminal` / `review` / `system`.
