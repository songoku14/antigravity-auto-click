...
### 🧪 Testing
Verify your setup with these simulation commands:
- `/test retry`: Simulates a High Traffic dialog.
- `/test accept`: Simulates an Agent "Run" or "Execute" dialog.
- `/test danger`: Simulates a dangerous command (should be blocked).
