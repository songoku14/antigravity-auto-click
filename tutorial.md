...
Để công cụ có thể giao tiếp với Antigravity, bạn **bắt buộc** phải mở IDE ở chế độ Debug. Ví dụ bên dưới dùng cổng `9222`, nhưng daemon thực tế sẽ tự dò port CDP từ tiến trình Antigravity.
